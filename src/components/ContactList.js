...
const ContactList = (props) => {
    ...
    return( 
            <div className="card">
                ...
                <Link to={`/contact/${props.contactId}`} className="viewListLink">
                    {props.name}
                </Link>
                    <Link to={`/chat/${props.contactId}`}>
                        <svg width="1.3em" height="1.3em" viewBox="0 0 16 16" 
                        className="bi bi-chat-right-text float-right m-2" 
                    ...
                    <svg width="1.3em" height="1.3em" viewBox="0 0 16 16" 
                    className="bi bi-trash float-right m-2" onClick={onDelete} 
                    fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <svg width="1.3em" height="1.3em" viewBox="0 0 16 16" 
                    className="bi bi-pencil float-right m-2"
                    fill="currentColor" xmlns="http://www.w3.org/2000/svg">
...
export default connect(undefined, mapDispatchToProps)(ContactList);